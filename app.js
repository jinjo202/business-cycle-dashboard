...
function updateExportCard() {
    ...
    const baselinePrices = {
        "US": {
            ...
            "VIX": { name: "iPath Volatility VIX ETN", ticker: "VIX", base: 18.77, format: (p) => `$${p.toFixed(2)}` },
...
function calculateSecondaryIndicators(macro, season, activeRegion, rate, eps, m2) {
    ...
    // KOSPI Top 10 Companies
        ...
        { name: "KB금융", ticker: "105560", baseMcap: 63.59, betaX: 2.5, betaY: 1.2, baseOffset: 18.0, price: 153700.0, fwdPE: 8.13, eps_trail: 0, eps_0q: 4578.9, eps_1q: 4985.44, eps_0y: 17648.36, eps_1y: 18906.17, ret_1d: 0.0, ret_1w: 0.0, ret_1m: 0.0, last_updated: "2026-06-23 15:30" },
