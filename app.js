...
function updateExportCard() {
    ...
    const baselinePrices = {
        "US": {
            ...
            "PYPL": { name: "PayPal Holdings Inc.", ticker: "PYPL", base: 47.37, format: (p) => `$${p.toFixed(2)}` },
            ...
            "VIX": { name: "iPath Volatility VIX ETN", ticker: "VIX", base: 16.37, format: (p) => `$${p.toFixed(2)}` },
        ...
        "KR": {
            "SK하이닉스": { name: "SK하이닉스", ticker: "000660", base: 2082000, format: (p) => `${Math.round(p).toLocaleString()}원` },
...
function calculateSecondaryIndicators(macro, season, activeRegion, rate, eps, m2) {
    ...
    const mcapSp500Total = 80.24 * (1 + ytdSp500 / 100);
    const mcapKospiTotal = 5957.67 * (1 + ytdKospi / 100);
    const mcapKosdaqTotal = 546.45 * (1 + ytdKosdaq / 100);

    // US S&P 500 Top 10 Companies
            const usTop10Defs = [
        { name: "NVIDIA Corp.", ticker: "NVDA", baseMcap: 5.13, betaX: 8.0, betaY: 6.0, baseOffset: 22.0, price: 201.07, fwdPE: 15.8, eps_trail: 6.53, eps_0q: 2.08, eps_1q: 2.35, eps_0y: 8.96, eps_1y: 12.73, ret_1d: -3.62, ret_1w: -5.34, ret_1m: -6.29, last_updated: "2026-06-24 00:16" },
        ...
        { name: "Alphabet Inc.", ticker: "GOOGL", baseMcap: 4.39, betaX: 3.8, betaY: 1.9, baseOffset: 8.0, price: 346.5, fwdPE: 23.81, eps_trail: 13.11, eps_0q: 2.87, eps_1q: 3.0, eps_0y: 14.22, eps_1y: 14.51, ret_1d: -0.89, ret_1w: -6.17, ret_1m: -10.83, last_updated: "2026-06-24 00:16" },
        { name: "Microsoft Corp.", ticker: "MSFT", baseMcap: 2.86, betaX: 4.0, betaY: 2.0, baseOffset: 10.0, price: 374.87, fwdPE: 19.38, eps_trail: 16.79, eps_0q: 4.24, eps_1q: 4.62, eps_0y: 16.84, eps_1y: 19.35, ret_1d: 2.05, ret_1w: -6.23, ret_1m: -9.89, last_updated: "2026-06-24 00:16" },
    ...
    // KOSPI Top 10 Companies
            const krTop10Defs = [
        { name: "삼성전자", ticker: "005930", baseMcap: 1835.35, betaX: 5.5, betaY: 3.0, baseOffset: 8.0, price: 310000.0, fwdPE: 5.34, eps_trail: 0, eps_0q: 11061.49, eps_1q: 13483.35, eps_0y: 45425.67, eps_1y: 58035.6, ret_1d: 0.0, ret_1w: 0.0, ret_1m: 0.0, last_updated: "2026-06-23 15:30" },
        { name: "SK하이닉스", ticker: "000660", baseMcap: 1477.92, betaX: 8.5, betaY: 5.0, baseOffset: 24.0, price: 2555000.0, fwdPE: 6.18, eps_trail: 0, eps_0q: 71064.06, eps_1q: 88259.91, eps_0y: 305490.4, eps_1y: 413579.4, ret_1d: 0.0, ret_1w: 0.0, ret_1m: 0.0, last_updated: "2026-06-23 15:30" },
        { name: "현대차", ticker: "005380", baseMcap: 113.64, betaX: 3.5, betaY: 1.5, baseOffset: 14.0, price: 511000.0, fwdPE: 10.36, eps_trail: 0, eps_0q: 12370.13, eps_1q: 12614.77, eps_0y: 44708.26, eps_1y: 49327.39, ret_1d: 0.0, ret_1w: 0.0, ret_1m: 0.0, last_updated: "2026-06-23 15:30" },
        { name: "LG에너지솔루션", ticker: "373220", baseMcap: 78.39, betaX: 6.0, betaY: 3.5, baseOffset: 5.0, price: 362000.0, fwdPE: 42.11, eps_trail: 0, eps_0q: 878.92, eps_1q: 2508.59, eps_0y: 1979.04, eps_1y: 8596.31, ret_1d: 0.0, ret_1w: 0.0, ret_1m: 0.0, last_updated: "2026-06-23 15:30" },
        ...
        { name: "삼성바이오로직스", ticker: "207940", baseMcap: 64.02, betaX: 1.8, betaY: 0.8, baseOffset: 7.0, price: 1273000.0, fwdPE: 26.41, eps_trail: 0, eps_0q: 8865.59, eps_1q: 9676.67, eps_0y: 42404.33, eps_1y: 48198.96, ret_1d: 0.0, ret_1w: 0.0, ret_1m: 0.0, last_updated: "2026-06-23 15:30" },
        { name: "KB금융", ticker: "105560", baseMcap: 64.41, betaX: 2.5, betaY: 1.2, baseOffset: 18.0, price: 153700.0, fwdPE: 8.13, eps_trail: 0, eps_0q: 4578.9, eps_1q: 4985.44, eps_0y: 17648.36, eps_1y: 18906.17, ret_1d: 0.0, ret_1w: 0.0, ret_1m: 0.0, last_updated: "2026-06-23 15:30" },
        { name: "기아", ticker: "000270", baseMcap: 56.36, betaX: 3.8, betaY: 1.6, baseOffset: 15.0, price: 137400.0, fwdPE: 5.82, eps_trail: 0, eps_0q: 6129.74, eps_1q: 5699.84, eps_0y: 21668.62, eps_1y: 23614.46, ret_1d: 0.0, ret_1w: 0.0, ret_1m: 0.0, last_updated: "2026-06-23 15:30" },
        { name: "신한지주", ticker: "055550", baseMcap: 50.37, betaX: 2.2, betaY: 1.1, baseOffset: 14.0, price: 97700.0, fwdPE: 7.58, eps_trail: 0, eps_0q: 3301.84, eps_1q: 3203.13, eps_0y: 11800.98, eps_1y: 12897.58, ret_1d: 0.0, ret_1w: 0.0, ret_1m: 0.0, last_updated: "2026-06-23 15:30" },
        { name: "현대모비스", ticker: "012330", baseMcap: 43.65, betaX: 2.5, betaY: 1.2, baseOffset: 6.0, price: 510000.0, fwdPE: 9.61, eps_trail: 0, eps_0q: 13246.62, eps_1q: 13516.65, eps_0y: 47320.18, eps_1y: 53062.31, ret_1d: 0.0, ret_1w: 0.0, ret_1m: 0.0, last_updated: "2026-06-23 15:30" }
    ];
